"""
Django settings for feedstack_project project.
...
REACT_APP_DIR = BASE_DIR / "client_build"
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'feedstack.fly.dev',]
...
ROOT_URLCONF = 'feedstack_project.urls'
...
WSGI_APPLICATION = 'feedstack_project.wsgi.application'
